function ChatList({ rooms, selectedRoom, setSelectedRoom }) {
    return (
        <div className="w-1/4 h-full bg-white shadow-lg flex flex-col overflow-y-auto border-r border-gray-200">
            <div className="px-4 py-2 text-base font-semibold border-b bg-gray-100 text-gray-800">Daftar Chat</div>
